...
!function(e){"function"==typeof define&&define.amd?define(["jquery"],e):e(jQuery)}(function(e){function t(e){return e}function a(e){return decodeURIComponent(e.replace(n," "))}function i(e){0===e.indexOf('"')&&(e=e.slice(1,-1).replace(/\\"/g,'"').replace(/\\\\/g,"\\"));try{return o.json?JSON.parse(e):e}catch(t){}}var n=/\+/g,o=e.cookie=function(n,c,s){if(void 0!==c){if(s=e.extend({},o.defaults,s),"number"==typeof s.expires){var r=s.expires,l=s.expires=new Date;l.setDate(l.getDate()+r)}return c=o.json?JSON.stringify(c):String(c),document.cookie=[o.raw?n:encodeURIComponent(n),"=",o.raw?c:encodeURIComponent(c),s.expires?"; expires="+s.expires.toUTCString():"",s.path?"; path="+s.path:"",s.domain?"; domain="+s.domain:"",s.secure?"; secure":""].join("")}for(var u=o.raw?t:a,p=document.cookie.split("; "),d=n?void 0:{},h=0,f=p.length;f>h;h++){var $=p[h].split("="),m=u($.shift()),b=u($.join("="));if(n&&n===m){d=i(b);break}n||(d[m]=i(b))}return d};o.defaults={},e.removeCookie=function(t,a){return void 0!==e.cookie(t)?(e.cookie(t,"",e.extend({},a,{expires:-1})),!0):!1}});